...
A simple, responsive, and user-friendly QR Code Generator web application built using Flask and Bootstrap. This project allows users to generate QR codes from URLs or text and download them instantly.
